package com.lzp.copyui.transition;
...
import com.lzp.copyui.transition.adapter.GarageAdapter;
import com.lzp.copyui.transition.gallery.GalleryRecyclerView;
import com.lzp.copyui.transition.gallery.IndicatorView;
import com.lzp.copyui.transition.transition.GarageEnterTransition;
import com.lzp.copyui.transition.transition.GarageReturnTransition;
import com.lzp.copyui.transition.transition.OtherTransition;
import com.lzp.copyui.transition.transition.PositionTransition;
...
public class GarageActivityNew extends BaseActivity {
    ...
    public void initView() {
        ...
        statusBarView.setBackgroundColor(getResources().getColor(R.color.color_statusbar_bg));
