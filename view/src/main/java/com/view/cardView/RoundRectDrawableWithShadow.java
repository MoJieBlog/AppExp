...
/**
 * @describe: copy from {@link androidx.cardview.widget.RoundRectDrawableWithShadow}
 * @Author: lixiaopeng
 * @Date: 2020-01-03
 */
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
                                       float shadowSize, float maxShadowSize,
                                       int shadowStartColor, int shadowEndColor, float shadowDelegate) {

        mShadowStartColor = shadowStartColor;
        mShadowEndColor = shadowEndColor;
        mTopDelta = shadowDelegate;
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.cardview_compat_inset_shadow);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
        setBackground(backgroundColor);
        mCornerShadowPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
